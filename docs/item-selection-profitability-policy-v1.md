# Item Selection Profitability Policy v1

## Contract

- Policy: `gonggamline-profitability-2026-07-27-v1`
- Effective date: `2026-07-27` (`Asia/Seoul`)
- Financial owner: Revenue
- Consumer: Supplier / Procurement Item Selection evaluator
- Risk: high-risk/manual because this Story changes contribution-profit and
...
Deductible VAT-inclusive values are compared net of VAT. Non-deductible VAT,
tax-exempt, and explicitly VAT-exclusive values retain their supplied amount.
...
presentation remain Stories 3–5 after their separate Architecture approvals.
