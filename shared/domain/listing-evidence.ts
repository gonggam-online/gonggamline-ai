export const LISTING_EVIDENCE_SCHEMA_VERSION = "gonggamline-listing-evidence-v1" as const;
export const LISTING_POLICY_RULESET_VERSION = "gonggamline-listing-policy-v1" as const;
...
export type ListingDisposition = "ADMITTED" | "QUARANTINED";
...
export interface ListingPolicyDecision {
  ...
  readonly subjectId: string;
  readonly evaluationId: string;
  readonly disposition: ListingDisposition;
