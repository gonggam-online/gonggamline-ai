  ...
  return (
    <main className="register-shell">
      <header className="register-hero">
        ...
        <div style={{display:"flex",gap:10,flexWrap:"wrap"}}><Link className="ghost-link" href="/seller">등록 운영센터</Link><Link className="ghost-link" href="/coupang">API 연동 센터</Link></div>
      </header>
