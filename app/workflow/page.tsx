...
export default function WorkflowPage() {
  ...
  return <main className="dashboard">
    <section className="hero" style={{background:"linear-gradient(135deg,#102a43,#0f766e)"}}>
      ...
      <div className="hero-actions"><Link className="button-link secondary-button" href="/workspace">상품 Workspace</Link><Link className="button-link secondary-button" href="/procurement">조달·발주</Link><Link className="button-link secondary-button" href="/listing">Listing AI</Link><Link className="button-link secondary-button" href="/seller">쿠팡 등록</Link><button onClick={reconcile} disabled={loading}>{loading?"동기화 중":"전체 자동 동기화"}</button></div>
    </section>
