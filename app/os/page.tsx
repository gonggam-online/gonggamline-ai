...
type Dashboard={overview:any;health:any;pipeline:any[];activities:any[];workers:any[];releases:any[];commands:any[];enterprise:any};
const money=(v:any)=>`${Math.round(Number(v||0)).toLocaleString("ko-KR")}원`;
