...
type Finder = { completedAt: string | null; summary: { trackedKeywords: number; actionableCount: number; providerCount: number }; keywordProfiles: Profile[]; contentFeed: Content[]; providerCoverage: string[]; collectorHealth: Collector[] };
