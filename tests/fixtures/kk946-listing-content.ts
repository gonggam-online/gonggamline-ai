...
export function kk946AcceptanceInput(): ListingContentInput {
  ...
  return {
    ...
    titleFieldOrder: ["productName", "modelName", "color", "material"], minimumRequiredFields: ["productName", "modelName", "color", "coupangCategoryContract", "productNoticeFacts"], corePurchaseFields: ["modelName", "color", "stockQuantity"], creativeFactFields: ["productName", "modelName", "color", "material", "dimensions"], keywordFields: ["productName", "modelName", "color"], customerIntents: [{ intentId: "portable-small-storage", query: "휴대용 소형 수납", attributeFields: ["productName", "dimensions", "color"] }, { intentId: "verify-pouch-size", query: "파우치 크기", attributeFields: ["dimensions"] }],
...
export function kk946WingRegistrationAdapter(privateFields: Kk946PrivateWingFields): Readonly<{
  ...
  const input: ListingContentInput = {
    ...
    creativeFactFields: ["productName", "modelName", "color", "material", "dimensions", "quantity", "closure", "style"],
