...
test("KK946 accepts an externally injected exact-category adapter without production hardcoding", () => {
  const { input, commerce } = kk946WingRegistrationAdapter({ vendorUserId: "fixture:private-wing-user", companyContactNumber: "fixture:private-wing-contact", returnZipCode: "00000", returnAddress: "fixture:private-return-address", returnAddressDetail: "fixture:private-return-detail" });
